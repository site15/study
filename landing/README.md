...
- Абсолютных путей для загрузки документов и ассетов с учетом базового пути (`${basePath}docs/`, `${basePath}assets/`)
- Обработке SPA маршрутизации через 404.html и клиентский JavaScript
